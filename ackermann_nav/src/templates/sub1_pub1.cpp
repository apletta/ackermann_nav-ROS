...
public:
  SubscribeAndPublish()
  {
    ...
    pub_1 = n.advertise<myControlMsg>("published_from_sub1_pub1", 1000);
    ...
    sub_1 = n.subscribe("published_from_pub1", 1000, &SubscribeAndPublish::callback, this);
  }
  ...
  void callback(const myControlMsg& input)
  {
    ...
    */
    ...
    output.vel_k_in = input.vel_k_in; //this line can be set to your variable
    output.head_k_in = input.vel_k_in;  //this line can be set to your variable
